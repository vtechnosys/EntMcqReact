        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-sm-4 col-12">
                    <h5>Get In Touch</h5>
                    <ul>
                        <li><a href="#"><i className="bi bi-telephone"></i>(000) 0000 0000</a></li>
                        <li><a href="#"><i className="bi bi-geo-alt"></i>4517 UK - 37</a></li>
                        <li><a href="#"><i className="bi bi-envelope"></i>info@demo.com</a></li>
                    </ul>
                </div>
            </div>
        </div>
